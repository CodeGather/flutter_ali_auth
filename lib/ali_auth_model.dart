...
class AliAuthModel {
  ...
  ///
  /// **⚠️** 原生 SDK iOS、Android 顺序不一致，插件统一处理为一致的顺序（左上、右上、右下、左下）。
  ///
  /// [Android 二次隐私协议弹窗页面](https://help.aliyun.com/zh/pnvs/developer-reference/the-android-client-access?spm=a2c4g.11186623.help-menu-75010.d_5_1_1_0.68123765JrbBtr&scm=20140722.H_2249362._.OR_help-T_cn~zh-V_1#639cf5d0e5z3b)
  ///
  /// [iOS 二次隐私协议弹窗页面](https://help.aliyun.com/zh/pnvs/developer-reference/the-ios-client-access?spm=a2c4g.11186623.help-menu-75010.d_5_1_1_1.718b743d0IIJ3P&scm=20140722.H_2249363._.OR_help-T_cn~zh-V_1#e0c2daa0e51ts)
